...
public class GoogleOAuthService {
    ...
    private String exchangeCodeForToken(String code, String codeVerifier) throws Exception {
        System.out.println("--- DEBUG TOKEN EXCHANGE ---");
        System.out.println("URL: " + GoogleOAuthConfig.TOKEN_ENDPOINT);
        System.out.println("Client ID: " + GoogleOAuthConfig.CLIENT_ID);
        System.out.println("Redirect URI: " + GoogleOAuthConfig.REDIRECT_URI);
        ...
        System.out.println("DEBUG: Sending token exchange request...");
        String response = httpPost(GoogleOAuthConfig.TOKEN_ENDPOINT, postBody);
        System.out.println("DEBUG: Response from Google: " + response);
